...
export const projects = [
  {
    ...
    description: "🚀 Production-ready distributed SQL engine built from scratch in Java. Features gRPC-based coordinator architecture, parallel query execution across partitioned datasets, and enterprise-grade fault tolerance with checkpointing & retry mechanisms.",
  ...
  },
  {
    ...
    description: "📊 Interactive PostgreSQL query optimization tool with real-time plan visualization. Features intelligent Index Advisor, bottleneck detection, and cost analysis to help developers optimize complex SQL queries with visual insights.",
  ...
  },
  {
    ...
    description: "⚡ High-throughput distributed event processing system handling 150K+ events/day with 99.99% uptime. Replaced 4 legacy services with Kafka-based architecture featuring idempotency controls, safe retries, and comprehensive observability.",
  ...
  },
  {
    ...
    description: "📄 Scalable document processing system handling 1,500+ uploads/min with AWS S3 & Lambda. Achieved 80% backend load reduction and $360K annual cost savings through intelligent load balancing and serverless architecture.",
  ...
  },
  {
    ...
    description: "🔍 Production-grade AI-powered semantic search engine indexing 5,000+ academic papers. Features RAG pipelines, Pinecone vector databases, sub-second latency, and GPU-backed APIs for scalable research discovery.",
  ...
  },
  {
    ...
    description: "🤖 Intelligent automated grading platform combining static analysis, plagiarism detection, and ML-based scoring. Features instructor-in-the-loop workflows with real-time analytics dashboards for comprehensive code evaluation and learning insights.",
